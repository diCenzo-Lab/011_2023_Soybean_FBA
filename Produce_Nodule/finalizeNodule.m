...
% biomasswostarchshootpos = find(contains(noduleModel.rxns,'BiomassWithOutStarch'));
...
% RootBiomass = find(ismember(ModelAdjustedForAsn.rxns,'R_BiomassRoot'));
% LeaveBiomass = find(ismember(ModelAdjustedForAsn.rxns,'R_BiomassShoot'));
